...
def readinput(window, q1_start_entry, q1_end_entry, q2_start_entry, q2_end_entry, q3_start_entry, q3_end_entry,
...
def Jac(window, q1_start_entry, q1_end_entry, q2_start_entry, q2_end_entry, q3_start_entry, q3_end_entry, l1_entry,
        l2_entry, l3_entry, load1_entry, load2_entry, load3_entry):
    global q1_st
    global q2_st
    global q3_st
    global q1_end
...
def inverse(window, q1_start_entry, q1_end_entry, q2_start_entry, q2_end_entry, q3_start_entry, q3_end_entry, l1_entry,
            l2_entry, l3_entry, x_entry, y_entry, theta_entry):
    global q1_st
    global q2_st
    global q3_st
    global q1_end
    ...
    q11_st = math.radians(q1_st)
    q11_end = math.radians(q1_end)
    q22_st = math.radians(q2_st)
    q22_end = math.radians(q2_end)
    q33_st = math.radians(q3_st)
    q33_end = math.radians(q3_end)
...
def workspace(window, q1_start_entry, q1_end_entry, q2_start_entry, q2_end_entry, q3_start_entry, q3_end_entry,
              l1_entry, l2_entry, l3_entry, v):
    global q1_st
    global q2_st
    global q3_st
    global q1_end
            ...
            for k in range(int(q3_st), int(q3_end)+1, range3):
                x.append(float("{0:.2f}".format(
                    l1 * math.cos(math.radians(i)) + l2 * math.cos(math.radians(i + j)) + l3 * math.cos(
                        math.radians(i + j + k)))))
                y.append(float("{0:.2f}".format(
                    l1 * math.sin(math.radians(i)) + l2 * math.sin(math.radians(i + j)) + l3 * math.sin(
                        math.radians(i + j + k)))))
...
def inputgui(window):
    ...
    button1 = Button(frame, text="DrawWorkSpace", fg="red", font=('Helvetica', 24),
                     command=lambda: workspace(window, q1_start_entry, q1_end_entry, q2_start_entry, q2_end_entry,
                                               q3_start_entry, q3_end_entry, l1_entry, l2_entry, l3_entry, v), height=2,
                     width=14)
    button1.grid(row=7, column=0, columnspan=41)
    frame2 = Frame(window)
    frame2.grid(row=50, column=0, columnspan=41, sticky=W)
    button2 = Button(frame2, text="DrawRobot", fg="red", font=('Helvetica', 24),
                     command=lambda: inverse(window, q1_start_entry, q1_end_entry, q2_start_entry, q2_end_entry,
                                             q3_start_entry, q3_end_entry, l1_entry, l2_entry, l3_entry, x_entry,
    ...
    button3 = Button(frame3, text="MaxLoad", fg="red", font=('Helvetica', 24),
                     command=lambda: Jac(window, q1_start_entry, q1_end_entry, q2_start_entry, q2_end_entry,
                                         ...
                                         load2_entry, load3_entry), height=1, width=14)
