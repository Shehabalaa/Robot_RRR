...
def inputgui(window):
    ...
    frame2 = Frame(window)
    frame2.grid(row=60,column=0,columnspan=41,sticky=W)
    button2 = Button(frame2, text="GetMaxLoad",fg="red",font=('Helvetica', 24),command= lambda: workspace(window,q1_start_entry,q1_end_entry,q2_start_entry,q2_end_entry,q3_start_entry,q3_end_entry,l1_entry,l2_entry,l3_entry), height=1, width=14)
    button2.grid(row=60,column=0,columnspan=41,sticky=W)
    frame3 = Frame(window)
    frame3.grid(row=120,column=0,columnspan=41,sticky=W+S)
    button3 = Button(frame3, text="DrawRobot",fg="red",font=('Helvetica', 24),command= lambda: workspace(window,q1_start_entry,q1_end_entry,q2_start_entry,q2_end_entry,q3_start_entry,q3_end_entry,l1_entry,l2_entry,l3_entry), height=1, width=14)
    button3.grid(row=120,column=0,columnspan=41,sticky=W+S)
